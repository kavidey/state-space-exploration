...
axs[0].plot(our_filtered_means[:, 0], our_filtered_means[:, 1], label="Our Filtered Means")
...
axs[1].plot(our_filtered_means[:, 0], our_filtered_means[:, 1], label="Our Filtered Means")
axs[1].legend()
axs[1].set_xlabel("x")
axs[1].set_ylabel("y")
